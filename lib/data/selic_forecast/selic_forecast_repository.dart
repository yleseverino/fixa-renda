...
class SelicForecastRepository {
  ...
  Future<void> updateForecast() async {
    ...
    final values = await _forecastService.getSelicForecastFromCentralBank(filter: formatFilterDateGreaterThan(lastDateSelic));
  ...
  Stream<List<SelicForecast>> getLastForecast() {
    return _selicForecastDao.getLastForecastByMeeting();
  }
}
